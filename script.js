...
// const NAV_W = 250; // width in px

// function openNav() {
//   document.getElementById("mySidenav").style.width = NAV_W + "px"; // show nav
//   document.body.style.marginLeft = NAV_W + "px";                   // push page over
// }

// function closeNav() {
//   document.getElementById("mySidenav").style.width = "0"; // hide nav
//   document.body.style.marginLeft = "0";                   // reset page
// }
